                                ...
                                <div class="modal-body">                          
                                  ...
                                  <div class="form-group">
                                    ...
                                    <select class="form-control" name="jenis">
                                      ...
                                      <option value="jas" <?php if('jas' == $d_tb_paket['jenis']){ echo 'selected'; } ?>>Jas</option>
                                      <option value="gorden" <?php if('gorden' == $d_tb_paket['jenis']){ echo 'selected'; } ?>>Gorden</option>
                                  ...
                                  <div class="form-group">
                                    <label>Harga</label>
                                    <input type="text" name="harga" value="<?php echo $d_tb_paket['harga']; ?>" class="form-control" placeholder="Masukan Harga" onkeypress="return hanyaAngka(event)">
                                  </div>                            
                                </div>                            
                                <div class="modal-footer justify-content-between">
                                  <button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
                          ...
                          <div class="modal-content">
                            ...
                            <form method="post" action="simpan_paket.php">
                             <div class="modal-body">                          
                              ...
                              <div class="form-group">
                                <label>Harga</label>
                                <input type="text" name="harga" class="form-control" placeholder="Masukan Harga" onkeypress="return hanyaAngka(event)">
                              </div>                            
                            </div>                            
                            <div class="modal-footer justify-content-between">
                              <button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
