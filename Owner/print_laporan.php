                                  ...
                                  <form method="post" action="update_transaksi.php">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="number" name="qty" value="<?php echo $d_tb_transaksi['qty']; ?>" class="form-control" placeholder="Masukan Berat" onkeypress="return hanyaAngka(event)">
                                      </div>  

                                      <div class="form-group">
                                        <label>Biaya Tambahan</label>
                                        <input type="number" name="biaya_tambahan" value="<?php echo $d_tb_transaksi['biaya_tambahan']; ?>" class="form-control" placeholder="Masukan Biaya Tambahan" onkeypress="return hanyaAngka(event)">
                                      </div>


                                      <div class="form-group">
                                        <label>Diskon</label>
                                        <input type="number" name="diskon" value="<?php echo $d_tb_transaksi['diskon']; ?>" class="form-control" placeholder="Masukan Diskon" onkeypress="return hanyaAngka(event)">
                                      </div>
                                ...
                                <div class="modal-body">
                                  <form method="post" action="simpan_transaksi.php">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label>Berat/PCS</label>
                                        <input type="number" name="qty" class="form-control" placeholder="Masukan Berat" onkeypress="return hanyaAngka(event)">
                                      </div>  

                                      <div class="form-group">
                                        <label>Biaya Tambahan</label>
                                        <input type="number" name="biaya_tambahan" class="form-control" placeholder="Masukan Biaya Tambahan" onkeypress="return hanyaAngka(event)">
                                      </div>

                                      <div class="form-group">
                                        <label>Diskon</label>
                                        <input type="number" name="diskon" class="form-control" placeholder="Masukan Diskon" onkeypress="return hanyaAngka(event)">
                                      </div>
